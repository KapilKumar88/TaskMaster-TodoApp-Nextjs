    ...
    >
      <div className="flex items-center justify-between p-3 border-b border-white/30">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-slate-900 dark:text-slate-800">Notifications</h3>
        </div>
        <div className="flex items-center gap-1">
          <Button variant="ghost" size="sm" className="h-8 px-2 text-xs text-slate-700" onClick={markAllAsRead}>
            Mark all as read
          </Button>
          <Button variant="ghost" size="icon" className="h-6 w-6 text-slate-700" onClick={onClose}>
            <X className="h-4 w-4" />
      ...
      <div className="py-1">
        {notifications.length === 0 ? (
          <div className="p-4 text-center text-sm text-slate-700">No notifications to show</div>
        ) : (
